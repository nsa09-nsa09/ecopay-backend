...
public class ErrorResponse {
  ...
  /**
   * Stable, machine-readable code (e.g. ACCOUNT_BANNED). Optional so legacy error responses stay
   * compatible — populated for structured cases like the banned-user login response.
   */
  private String code;
