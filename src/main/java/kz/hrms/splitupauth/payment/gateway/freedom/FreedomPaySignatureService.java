 ...
 *
 * <p>Signature algorithm: 1. Take all params except `pg_sig` 2. Sort by key (alphabetical) 3.
 * Concatenate values with `;` between, prefixed by script name and suffixed by secret key 4. MD5
 * the result and lowercase hex
 *
 * <p>See: https://docs.freedompay.kz/
 */
@Component
