...
public class PaymentGatewayRegistry {
  ...
  /**
   * Active provider for the default flow: {@code freedompay} in prod, {@code mock} in dev/test (see
  ...
  public PaymentGateway resolve(String providerName) {
    ...
    PaymentGateway gateway =
        byName.get(providerName == null ? FreedomPayGateway.PROVIDER_NAME : providerName);
    if (gateway == null) {
