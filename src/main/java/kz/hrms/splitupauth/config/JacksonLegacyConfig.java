 ...
 *
 * <p>Timezone alignment with the Jackson 3.x mapper: every LocalDateTime is
 * serialized as an ISO offset string in Asia/Almaty (+05:00). Without this
 * the legacy mapper would emit a zoneless ISO string that the frontend can't
 * disambiguate.
 */
@Configuration
