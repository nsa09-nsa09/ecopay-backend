...
/**
 * Input-side guards for service-logo uploads. Mirrors {@link NewsImageUploadProperties}; logos sit
 * on a smaller target width since the FE only renders them at icon size.
 */
@Getter
@Setter
