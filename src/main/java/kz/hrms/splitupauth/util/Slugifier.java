...
/**
 * Generates URL-safe slugs from human-readable names. Handles common Cyrillic transliteration so
 * the resulting slug stays readable for KZ/RU inputs (e.g., "Видео" → "video", "Билайн" →
 * "bilain"). Caller is responsible for ensuring uniqueness — see {@link #appendSuffix}.
 */
public final class Slugifier {
  ...
  public static String slugify(String input) {
    ...
    String normalized =
        Normalizer.normalize(transliterated, Normalizer.Form.NFKD)
