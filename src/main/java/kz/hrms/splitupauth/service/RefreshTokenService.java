...
public class RefreshTokenService {
  ...
  /**
   * Issues a new refresh token. The raw token is returned to the caller (sent to the client); only
   * its SHA-256 hash is persisted, so a DB leak cannot reveal live tokens.
   */
  @Transactional
