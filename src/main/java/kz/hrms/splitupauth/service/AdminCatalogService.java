...
public class AdminCatalogService {
  ...
  public AdminCategoryDto createCategory(
    ...
    writeLog(
        admin,
        AdminActionType.CATEGORY_CREATED,
        "CATEGORY",
        category.getId(),
        null,
        null,
  ...
  public AdminCategoryDto updateCategory(
    ...
    writeLog(
        admin,
        AdminActionType.CATEGORY_UPDATED,
        "CATEGORY",
        category.getId(),
        null,
        oldState,
  ...
  public void deleteCategory(Long id, User admin, HttpServletRequest http) {
    ...
    writeLog(
        admin,
        AdminActionType.CATEGORY_DELETED,
        "CATEGORY",
        category.getId(),
        null,
        oldState,
  ...
  public AdminServiceDto createService(
    ...
    writeLog(
        admin,
        AdminActionType.SERVICE_CREATED,
        "SERVICE",
        service.getId(),
        null,
        null,
  ...
  public AdminServiceDto updateService(
    ...
    writeLog(
        admin,
        AdminActionType.SERVICE_UPDATED,
        "SERVICE",
        service.getId(),
        null,
        oldState,
  ...
  /**
   * Upload + replace the S3-backed logo on a service. Old key is best-effort deleted (mirrors
   * {@code NewsService#uploadImage}). Logged to admin_action_log as SERVICE_UPDATED — we reuse the
   * existing action type rather than introducing a new SERVICE_LOGO_* family because the change
  ...
  public void deleteService(Long id, User admin, HttpServletRequest http) {
    ...
    writeLog(
        admin,
        AdminActionType.SERVICE_DELETED,
        "SERVICE",
        service.getId(),
        null,
        oldState,
  ...
  public AdminTariffDto createTariff(
    ...
    TariffPlan tariff =
        TariffPlan.builder()
            ...
            .currency(
                req.getCurrency() != null && !req.getCurrency().isBlank()
                    ? req.getCurrency()
                    : "KZT")
    ...
    writeLog(
        admin,
        AdminActionType.TARIFF_CREATED,
        "TARIFF",
        tariff.getId(),
        null,
        null,
  ...
  public AdminTariffDto updateTariff(
    ...
    oldState.put(
        "basePriceTotal",
        tariff.getBasePriceTotal() != null ? tariff.getBasePriceTotal().toPlainString() : null);
    ...
    writeLog(
        admin,
        AdminActionType.TARIFF_UPDATED,
        "TARIFF",
        tariff.getId(),
        null,
        oldState,
  ...
  public void deleteTariff(Long id, User admin, HttpServletRequest http) {
    ...
    writeLog(
        admin,
        AdminActionType.TARIFF_DELETED,
        "TARIFF",
        tariff.getId(),
        null,
        oldState,
