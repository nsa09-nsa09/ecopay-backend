...
/**
 * Internal application event published by {@link NotificationService} once a
 * notification's in-app row is persisted. Consumed after transaction commit so
 * we never push/email for a change that gets rolled back. See
 * {@code NotificationDeliveryListener}.
 *
