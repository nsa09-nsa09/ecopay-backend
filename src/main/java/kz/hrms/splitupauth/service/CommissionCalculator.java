 ...
 *
 * <p>The room owner never pays a commission — only joining members do. The fee is a
 * <b>fixed amount per tier</b> of the per-member share (not a percentage):
 *
 * <pre>
 *   share ≤ 4 000  → 500
 *   4 001 – 6 000  → 700
 ...
 * </pre>
 *
 * The member is charged {@code share + commission}; the owner is paid the full
 * {@code share}; ECOpay keeps the {@code commission}. Thresholds and fees are
 * configurable via {@code app.commission.*} properties so the table can be tuned
...
public class CommissionCalculator {
    ...
    /**
     * ECOpay commission for a given per-member tariff share. A non-positive or null
     * share yields a zero commission (defensive — callers validate the share first).
     */
