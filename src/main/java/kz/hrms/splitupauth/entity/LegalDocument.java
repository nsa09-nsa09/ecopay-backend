...
/**
 * Editable legal document (Terms of Service / Privacy consent) shown on the registration page and
 * public /terms and /privacy pages. Modeled after {@link SiteContent} but there is one row per
 * doc_type value.
 */
@Entity
