...
/**
 * Whitelist of currencies a room owner may price in. KZT is the platform's settlement currency;
 * everything else is stored alongside a KZT snapshot (see V27) so we can aggregate revenue without
 * round-tripping FX rates.
 */
