...
/**
 * Public read-only access to the current legal document (Terms of Service /
 * Privacy consent). Mounted under {@code /api/v1/site} so it's covered by the
 * existing {@code /api/v1/site/**} permitAll rule in SecurityConfig.
 */
@RestController
