...
public class AdminModerationController {
  ...
  public ResponseEntity<ModerationQueueItemDto> assignToMe(
      @PathVariable Long queueId, @AuthenticationPrincipal User user) {
  ...
  public ResponseEntity<List<ModerationQueueItemDto>> batchConfirm(
      ...
      HttpServletRequest httpRequest) {
    return ResponseEntity.ok(moderationService.batchConfirmMemberships(user, request, httpRequest));
  }
