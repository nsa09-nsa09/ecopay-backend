...
/**
 * Pushes a freshly created {@link NotificationDto} to the recipient's personal
 * notifications topic. Subscription is owner-only, enforced by
 * {@link WebSocketAuthChannelInterceptor#validateSubscription} via the
 * {@code /topic/users/{id}/notifications} pattern.
 */
@Service
