...
/**
 * One row per {@link NotificationType} in the preferences screen. {@code email}
 * is only meaningful when {@code emailEligible} is true; the UI hides/disables
 * the email toggle for in-app-only types.
 */
@Data
@Builder
@NoArgsConstructor
...
public class NotificationPreferenceDto {
    ...
    public static NotificationPreferenceDto resolve(NotificationType type, NotificationPreference pref) {
