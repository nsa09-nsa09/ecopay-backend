...
/**
 * Personal analytics surface for the "my dashboard" page. Aggregates a user's
 * memberships, spend and reputation into a single payload so the SPA renders
...
public class MemberDashboardDto {
    ...
    /**
     * Estimated savings: across all ACTIVE memberships, the gap between solo
     * pricing (priceTotal) and the user's share (pricePerMember). Approximate —
     * relies on the room owner reporting truthful priceTotal at creation.
     */
