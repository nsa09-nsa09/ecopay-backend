...
public class SiteContentDto {
  ...
  /**
   * Convenience for clients that don't want to pick fields themselves. Collapses the chosen
   * language back into the legacy {title,mission,description} slots while keeping the per-language
   * fields available.
   */
  public SiteContentDto preferLanguage(String lang) {
    ...
    switch (normalised) {
      ...
      default -> {
        /* unknown locale — leave the legacy fields untouched */
      }
    }
    return this;
  }
