...
public interface NewsRepository extends JpaRepository<News, Long> {
    ...
    /**
     * Public feed: only published items, sorted by sort_order ascending then
     * published_at descending. Caller passes the page request; the sort is
     * embedded here so callers can't accidentally fall back to insertion order.
     */
