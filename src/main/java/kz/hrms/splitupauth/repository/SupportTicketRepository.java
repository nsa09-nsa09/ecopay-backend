...
public interface SupportTicketRepository extends JpaRepository<SupportTicket, Long> {
  ...
  boolean existsByRoomMemberAndTopicAndStatusIn(
      RoomMember roomMember, String topic, List<SupportTicketStatus> statuses);

  boolean existsByRoomMemberAndStatusIn(RoomMember roomMember, List<SupportTicketStatus> statuses);

  Optional<SupportTicket> findByIdAndRoomMemberAndStatusIn(
      Long id, RoomMember roomMember, List<SupportTicketStatus> statuses);
  ...
  Page<SupportTicket> findByStatusInOrderByCreatedAtAsc(
      List<SupportTicketStatus> statuses, Pageable pageable);

  Page<SupportTicket> findByAssignedAdminOrderByUpdatedAtDescCreatedAtDesc(
      User assignedAdmin, Pageable pageable);
