...
/**
 * Guards the public-profile avatar wiring: {@link ReviewService#getReputation(Long)}
 * must surface the avatar URL the same way the own-profile endpoint does, via
 * {@link AvatarStorageService#publicUrl(String)}. Storage and review aggregation
 * are mocked — this test only cares about the DTO assembly.
 */
...
class ReviewServiceReputationAvatarTest {
    ...
    private ReviewService service() {
        return new ReviewService(reviewRepository, userRepository, roomRepository,
                roomMemberRepository, reputationService, avatarStorageService);
    }
